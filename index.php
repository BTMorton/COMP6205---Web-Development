		...
		<div id="wrapper">
			...
			<div id="tutorials" class="container">
				...
				<div class="stories">
					...
					<div class="video" id="trimvideo">
					<img src="img/holding.png" alt="Tutorial holding image" onclick='loadVid("trimvideo", "videos/trim.mp4")'>
					</div>
					<h3>2. Trim</h3>
				  ...
				  <div class="video" id="silencevideo">
					<img src="img/holding.png" alt="Tutorial holding image" onclick='loadVid("silencevideo", "videos/silence.mp4")'>
					</div>
					<h3>3. Silence</h3>
					...
					<div class="video" id="fadeinvideo">
					<img src="img/holding.png" alt="Tutorial holding image" onclick='loadVid("fadeinvideo", "videos/fadein.mp4")'>
					</div>
					<h3>4. Fade in</h3>
					...
					<div class="video" id="fadeoutvideo">
					<img src="img/holding.png" alt="Tutorial holding image" onclick='loadVid("fadeoutvideo", "videos/fadeout.mp4")'>
					</div>
					<h3>5. Fade out</h3>
					...
					<div class="video" id="slowdownvideo">
					<img src="img/holding.png" alt="Tutorial holding image" onclick='loadVid("slowdownvideo", "videos/slowdown.mp4")'>
					</div>
					<h3>6. Slow down</h3>
					...
					<div class="video" id="speedupvideo">
					<img src="img/holding.png" alt="Tutorial holding image" onclick='loadVid("speedupvideo", "videos/speedup.mp4")'>
					</div>
					<h3>7. Speed up</h3>
